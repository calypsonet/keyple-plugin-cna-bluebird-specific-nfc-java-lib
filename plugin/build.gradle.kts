...
dependencies {
  // Bluebird libs (from GitHub Packages — com.calypsonet.private)
  compileOnly("com.calypsonet.private:bluebird-extnfc:1.0.0")
  compileOnly("com.calypsonet.private:sam-ng:1.0.0")
